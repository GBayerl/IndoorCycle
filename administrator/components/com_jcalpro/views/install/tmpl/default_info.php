<?php
/**
 * @version		$Id: default_info.php 801 2012-09-07 15:44:13Z jeffchannell $
 * @package		JCalPro
...
<div id="jcl_install" style="text-align:left">
	<div style="padding-left:13px">
		<?php echo JHtml::_('jcalpro.image', 'jcal_logo.png', array('alt' => JText::_('COM_JCALPRO_INSTALLER_TITLE'))); ?>
	</div>
	<div class="clr"></div>
