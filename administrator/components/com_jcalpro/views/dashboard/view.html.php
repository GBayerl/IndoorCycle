...
class JCalProViewDashboard extends JCalProView
{
	...
	function addToolBar() {
		JToolBarHelper::title(JText::_(parent::$option . '_DASHBOARD_TITLE'), 'jcalpro');
		parent::addToolBar();
	}
	...
	private function getButtons() {
		if (empty($this->buttons)) {
			...
			,	'text'  => JText::_('COM_JCALPRO_EVENTS_MANAGER_BUTTON')
			);
			// categories
			$buttons[] = array(
				'link'  => JCalProHelperUrl::_(array('option' => 'com_categories', 'extension' => parent::$option))
			,	'image' => JHtml::_('jcalpro.image', 'icon-48-category.png')
			//,	'image' => JHtml::_('jcalpro.spacer', 48, 48, array('class' => 'icon-48-categories'))
