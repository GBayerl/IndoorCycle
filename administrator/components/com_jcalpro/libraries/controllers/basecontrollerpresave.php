<?php
/**
 * @version		$Id: basecontrollerpresave.php 833 2012-11-05 21:40:49Z jeffchannell $
 * @package		JCalPro
...
jimport('legacy.controller.form') or jimport('joomla.application.component.controllerform');

class JCalProPreSaveController extends JControllerForm
{
	/**
