<?php
/**
 * @version		$Id: basemodel.php 811 2012-10-09 15:51:00Z jeffchannell $
 * @package		JCalPro
...
class JCalProBaseModel extends JCalProBaseModelCommon
{
	...
	public static function addIncludePath($path = '', $prefix = '') {
		...
		if (!array_key_exists($key, $paths)) {
			JCalProHelperLog::debug(JText::sprintf('COM_JCALPRO_ADDING_NEW_MODEL_PATH', $path));
	...
	public static function getInstance($type, $prefix = '', $config = array()) {
		$class = $prefix . $type;
		JCalProHelperLog::debug(JText::sprintf('COM_JCALPRO_GETTING_NEW_MODEL_INSTANCE', $class));
