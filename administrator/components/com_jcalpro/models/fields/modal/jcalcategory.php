<?php
/**
 * @version		$Id: jcalcategory.php 799 2012-08-08 22:56:32Z jeffchannell $
 * @package		JCalPro
...
class JFormFieldModal_JCalCategory extends JFormField
{
	...
	protected function getInput() {
		...
		$html[] = '		<a id="'.$this->id.'_modal" class="modal button" title="'.JText::_('COM_JCALPRO_CHANGE_CATEGORY').'"  href="'.$link.'" rel="{handler: \'iframe\', size: {x: 500, y: 250}}">'.$buttontext.'</a>';
		$html[] = '	</div>';
		$html[] = '</div>';
