<?php
/**
 * @version		$Id: jcallocation.php 780 2012-05-03 02:21:55Z jeffchannell $
 * @package		JCalPro
...
class JFormFieldModal_JCalLocation extends JFormField
{
	...
	protected function getInput() {
		...
		$html[] = '		<a id="'.$this->id.'_modal" class="modal" title="'.JText::_('COM_JCALPRO_CHANGE_LOCATION').'"  href="'.$link.'" rel="{handler: \'iframe\', size: {x: 800, y: 450}}">'.$buttontext.'</a>';
		$html[] = '	</div>';
		$html[] = '</div>';
