<?php
/**
 * @version		$Id: jcalevent.php 799 2012-08-08 22:56:32Z jeffchannell $
 * @package		JCalPro
...
class JFormFieldModal_JCalEvent extends JFormField
{
	...
	protected function getInput() {
		...
		$html[] = '		<a class="modal" title="'.JText::_('COM_JCALPRO_CHANGE_EVENT').'"  href="'.$link.'" rel="{handler: \'iframe\', size: {x: 800, y: 450}}">'.JText::_('COM_JCALPRO_CHANGE_EVENT_BUTTON').'</a>';
		$html[] = '	</div>';
		$html[] = '</div>';
