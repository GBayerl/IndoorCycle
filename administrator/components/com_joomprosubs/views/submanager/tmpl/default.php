	...
	<table class="adminlist">
			...
			<tr>
				...
				<th class="title" style="width: 20%;">
					...
					<?php echo JHtml::_('grid.sort',  'JSTATUS', 'a.published', $listDirn, $listOrder); ?>
		                ...
		                <th style="width: 5%">
                                    <?php echo JHtml::_('grid.sort', 'COM_JOOMPROSUBS_FIELD_BEGIN_LABEL', 'a.begin', $listDirn, $listOrder); ?>
                                </th>
				...
				<th style="width: 20%;">
					<?php echo JHtml::_('grid.sort',  'COM_JOOMPROSUBS_FIELD_TRAINER_LABEL', 'a.trainer', $listDirn, $listOrder); ?>
				</th>
		...
		<?php foreach ($this->items as $i => $item) :
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td class="center">
					<?php echo $this->escape($item->trainer); ?>
				</td>
