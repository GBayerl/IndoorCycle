	...
	<div class="width-60 fltlft">
		<fieldset class="adminform">
			...
			<?php echo $this->form->getInput('alias'); ?></li>
      			...
      			<li><?php echo $this->form->getLabel('trainer'); ?>
			<?php echo $this->form->getInput('trainer'); ?></li>
                       
                        <li><?php echo $this->form->getLabel('date'); ?>
			<?php echo $this->form->getInput('date'); ?></li>
                        
                        <li><?php echo $this->form->getLabel('begin'); ?>
			<?php echo $this->form->getInput('begin'); ?></li>
                        
                        <li><?php echo $this->form->getLabel('duration'); ?>
			<?php echo $this->form->getInput('duration'); ?></li>
                        
                        <li><?php echo $this->form->getLabel('bikes'); ?>
			<?php echo $this->form->getInput('bikes'); ?></li>
