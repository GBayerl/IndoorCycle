<?php
/**
 * @version		$Id: controller.php 799 2012-08-08 22:56:32Z jeffchannell $
 * @package		JCalPro
...
class JCalProController extends JCalProBaseController
{
	...
	public function module() {
		...
		switch ($type) {
			...
			case 'mod_jcalpro_locations':
				break;
			default:
				JError::raiseError(404, JText::_('COM_JCALPRO_MODULE_NOT_ALLOWED'));
		}
		// we need to get the module id
		...
		if (empty($id)) {
			...
			if (!($module = $db->loadObject())) JError::raiseError(404, JText::_('COM_JCALPRO_MODULE_NOT_FOUND'));
		}
	...
	public function plugin() {
		...
		if (class_exists($class)) $instance = new $class($dispatcher, JArrayHelper::fromObject($pdata));
