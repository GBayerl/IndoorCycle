<?php
/**
 * @version		$Id: registration.php 823 2012-10-23 06:08:24Z jeffchannell $
 * @package		JCalPro
...
class JCalProControllerRegistration extends JCalProPreSaveController
{
	...
	public function confirm() {
		...
		if ($db->getAffectedRows()) {
			...
			if (!property_exists($event, 'registration_data')) $event->registration_data = new stdClass;
	...
	public function add() {
		...
		$id = JFactory::getApplication()->input->get('event_id', 0, 'int');
