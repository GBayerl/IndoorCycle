<?php
/**
 * @version		$Id: categories.php 831 2012-10-30 18:16:47Z jeffchannell $
 * @package		JCalPro
...
class JCalProModelCategories extends JCalProListModel
{
	 ...
	 * @var		string
	 */
	public $_context = 'com_jcalpro.categories';
	...
	public function getItems() {
		...
		$upcoming_query->where('(Event.start_date >= ' . $db->Quote($today->toSql()) . ' AND Event.start_date < ' . $db->Quote($today->addMonth()->toSql()) . ')');
