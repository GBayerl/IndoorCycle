<?php
/**
 * @version		$Id: category.php 799 2012-08-08 22:56:32Z jeffchannell $
 * @package		JCalPro
...
class JCalProModelCategory extends JCalProListModel
{
	 ...
	 * @var		string
	 */
	public $_context = 'com_jcalpro.category';
	...
	protected function getListQuery() {
		...
		$this->_eventModel->setState('filter.date_range', 2);
	...
	public function getCategory() {
		...
		$catsModel = JCalPro::getModelInstance('Categories', 'JCalProModel');
	...
	public function getItems() {
		...
		if (!empty($items)) foreach ($items as &$item) $this->_eventModel->prepareEvent($item);
