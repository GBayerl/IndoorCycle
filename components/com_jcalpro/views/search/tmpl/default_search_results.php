<?php
/**
 * @version		$Id: default_search_results.php 822 2012-10-22 23:06:00Z jeffchannell $
 * @package		JCalPro
...
<table class="jcl_table">
	...
	<tbody>
		...
		<tr class="jcl_row jcl_row_<?php echo (0 == ($i + 1) % 2 ? 'even' : 'odd'); ?>">
			...
			<td align="center">
				<span class="atomic"><?php echo JCalProHelperFilter::escape($item->user_microdisplay); ?></span>
			</td>
		</tr>
		<?php endforeach; ?>
