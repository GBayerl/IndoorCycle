<?php
/**
 * @version		$Id: default_event_admin.php 782 2012-05-03 17:01:12Z jeffchannell $
 * @package		JCalPro
...
if ($user->authorise('core.edit', $context) || $user->authorise('core.edit.own', $context) || $isMine) :
	?><a class="hasTip" href="<?php echo JCalProHelperUrl::task('event.edit', true, array('id'=>$event->id)); ?>" title="<?php echo JText::_('COM_JCALPRO_EVENT_EDIT_TOOLTIP'); ?>"><?php
		echo JHtml::_('jcalpro.image', 'icon-edit.png');
	?></a><?php
endif;
?>
