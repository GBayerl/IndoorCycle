<?php
/**
 * @version		$Id: default_ajax.php 772 2012-04-17 19:21:09Z jeffchannell $
 * @package		JCalPro
...
<div style="display:none;">
	<form action="" method="post" id="jcl_layout_values">
		...
		<div id="jcl_layout_toolbar"><?php echo JHtml::_('jcalpro.mainmenu', isset($this->buttons) ? $this->buttons : array()); ?></div>
	</form>
</div>
<?php
endif;