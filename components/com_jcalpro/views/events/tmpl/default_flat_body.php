<?php
/**
 * @version		$Id: default_flat_body.php 822 2012-10-22 23:06:00Z jeffchannell $
 * @package		JCalPro
...
<h2 class="jcl_header"><a id="w<?php echo $i; ?>" name="w<?php echo $i; ?>"><!--  --></a><?php
	echo $this->items[$i]['user_datetime']->format(JText::_('COM_JCALPRO_DATE_FORMAT_FULL_DATE'));
?></h2>	
<?php
		foreach ($this->items[$i]['events'] as $n => $event) :
?>
<div class="jcl_row jcl_row_<?php echo (0 == ($n + 1) % 2 ? 'even' : 'odd'); ?>">
