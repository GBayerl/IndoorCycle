<?php
/**
 * @version		$Id: mod_jcalpro_calendar.php 814 2012-10-10 23:44:59Z jeffchannell $
 * @package		JCalPro
...
JLoader::register('JCalProHelperLog', JCalProHelperPath::helper('log'));
...
if ($showtip) JHtml::_('behavior.tooltip', '.jcalpro_calendar_tip_' . $module->id);
