...
$template_width = $this->params->get("templateWidth", "wide");
...
// Template color: blue | red | green | christmas
$template_color = $this->params->get("templateColor", "christmas");
...
$color_icons = $this->params->get("colorIcons", "blue,red,green,christmas");
...
if ($css_compression)
{
	...
	// apply VM style
	if ($jsnutils->checkVM()) {
		$css_compress_files[$template_path.'/ext/vm/jsn_ext_vm.css']['file_abs_path']	= $template_abs_path. DIRECTORY_SEPARATOR .'ext'. DIRECTORY_SEPARATOR .'vm';
		$css_compress_files[$template_path.'/ext/vm/jsn_ext_vm.css']['file_name']		= 'jsn_ext_vm.css';
	}
